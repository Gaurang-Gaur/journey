...
// this part respond res to reach to home directory "/" and then call function on reaching the home directory
app.get("/", function (req, res) {
    ...
    app.post("/", function (req, res) {
        ...
        const url = "https://api.openweathermap.org/data/2.5/weather?q=" + query + ",fr&appid=f34d39f3ba80e7672a11300e0966eb28";
        ...
        https.get(url, function (respond) {
            ...
            respond.on("data", function (data) {
                ...
                res.write("<h1>The temperature of "+query+" :" + temp + "Kelvien</h1>");
